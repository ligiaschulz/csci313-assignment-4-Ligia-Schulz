# Generated by Django 5.0.2 on 2024-03-28 22:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.CharField(blank=True, help_text='Language this particular book is written in', max_length=100, null=True)),
        ...
        migrations.AddConstraint(
            model_name='genre',
            constraint=models.UniqueConstraint(django.db.models.functions.text.Lower('name'), name='genre_name_case_insensitive_unique', violation_error_message='Genre alreday exists (case insensitive match)'),
        ),
        migrations.AddField(
            model_name='book',
            name='genre',
